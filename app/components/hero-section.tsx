  ...
  return (
    <section id="top" className="relative py-16 md:py-24">
      ...
      <Reveal className="mx-auto max-w-5xl text-center">
        ...
        <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-orange-400/20 bg-stone-900/80 px-4 py-2 text-sm text-orange-100">
          <span className="h-2 w-2 animate-pulse rounded-full bg-orange-400" />
          Free &amp; open source — built on OpenClaw
        </div>

        <h1 className="mx-auto mt-8 max-w-4xl text-balance text-5xl font-semibold tracking-tight text-stone-50 sm:text-6xl md:text-7xl">
          The all-in-one{" "}
        ...
        <p className="mx-auto mt-6 max-w-3xl text-pretty text-lg leading-relaxed text-stone-300 md:text-xl">
        ...
        <div className="mt-10 flex justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 px-7 py-3.5 text-base font-medium text-white shadow-lg shadow-orange-500/25 transition hover:from-orange-400 hover:to-orange-500"
          >
