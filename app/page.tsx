...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-x-clip bg-background text-foreground">
      ...
      >
        <div className="flex items-center gap-1.5 rounded-full bg-[#ff6154]/70 pl-2.5 pr-3 py-1.5 shadow-lg shadow-[#ff6154]/20 transition animate-[pulse-subtle_3s_ease-in-out_infinite] group-hover:bg-[#ff6154] group-hover:shadow-[#ff6154]/40 group-hover:scale-105 group-hover:[animation-play-state:paused]">
          {/* P circle */}
      ...
      >
        <div
          className="absolute flex items-center justify-center bg-[#ff6154] text-white shadow-lg transition-all animate-[pulse-subtle_3s_ease-in-out_infinite] group-hover:bg-[#ff5043] group-hover:shadow-xl group-hover:shadow-[#ff6154]/30 group-hover:[animation-play-state:paused]"
          style={{
            width: "340px",
