    ...
    <div className="relative min-h-screen overflow-x-clip bg-background text-foreground">
      ...
      >
        <div className="relative flex items-center justify-center h-12 w-12">
          ...
          {/* P logo */}
          <svg className="relative h-4 w-4 text-white z-10" viewBox="0 0 40 40" fill="currentColor"><path d="M22.667 20H17.333V13.333H22.667C24.507 13.333 26 14.827 26 16.667C26 18.507 24.507 20 22.667 20ZM22.667 10H14V30H17.333V23.333H22.667C26.347 23.333 29.333 20.347 29.333 16.667C29.333 12.987 26.347 10 22.667 10Z"/></svg>
        </div>
      </a>
